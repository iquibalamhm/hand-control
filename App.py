...
class App:
    ...
    # @return   null
    #
    def __init__(self, t="Application", x=550, y=400, f=30,simulation = 'Parabolic',cam = 'WebCam'):
        self.title     = t
        self.size      = (x, y)
        self.center    = (x/2, y/2)
        self.framerate = f
        self.simulation = simulation
        self.cameraSelection = cam
        self.Initialize()
    ...
    def Run(self):
        ...
        while self.running:
            ...
            if self.simulation == 'Line':
                pass
            elif self.simulation == 'Parabolic':
                self.Update()
                self.Render()
    ...
    # Clears the composites, particles and constraints
    #
    # @param    null
    # @return   null
    #
